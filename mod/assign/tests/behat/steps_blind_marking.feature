...
Feature: Assignments correctly add feedback to the grade report when workflow and blind marking are enabled.
  ...
  Background:
    ...
    And I click on "Grade" "mod_assign > context menu" in the "I'm the student's first submission" "table_row"
  ...
  Scenario: Student identities are revealed after releasing the grades.
    When I click on "Grade" "mod_assign > context menu" in the "I'm the student's first submission" "table_row"
    And I choose "Grade" in the open action menu

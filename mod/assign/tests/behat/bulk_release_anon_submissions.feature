...
Feature: Bulk released grades should not be sent to gradebook while submissions are anonymous.
  ...
  Background:
    ...
    And I click on "Grade" "mod_assign > context menu" in the "I'm student1's submission" "table_row"
    ...
    And I click on "Grade" "mod_assign > context menu" in the "I'm student2's submission" "table_row"
    And I choose "Grade" in the open action menu
